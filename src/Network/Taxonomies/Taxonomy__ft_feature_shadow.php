 ...
 */
class Taxonomy__ft_feature_shadow extends Taxonomy__Abstract implements Taxonomy__LinksShadowedPost__Interface
{
	 ...
	 */
	const NAME = 'ft_feature_shadow';

	protected $menu_icon_charcode = 'f314';
	...
	protected function prepare_labels() : array
	{
		return $this->labels = [
			...
			'singular' => __('Feature','figurentheater'),
			'plural'   => __('Features','figurentheater'),
	...
	protected function register_extended_taxonomy__args() : array
	{
		return [
			...
			// 'meta_box' => 'simple', //KEEP DISABLED !!!!!! tried 2 times // triggers JS problems in Gutenberg when editing 'ft_site'
...
} // END Class Taxonomy__ft_feature_shadow
