...
final class ProxiedFeaturesCollection extends SiteParts\ProxiedSitePartsCollectionAbstract { // (inherited) // implements SiteParts\SitePartCollection 
	...
	*/
	...
	{
		return ( $input instanceof Feature__Interface );
	}
}
