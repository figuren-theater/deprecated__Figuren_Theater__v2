...
// Static Proxy.
final class UtilityFeaturesCollection extends SiteParts\SitePartsCollectionAbstract
{
	...
	public static function get_collection() : SiteParts\SitePartsCollectionInterface {
		...
		if ( null === $collection ) {
			...
			$collection = new ProxiedUtilityFeaturesCollection();
		}
...
\Figuren_Theater\API::add('UtilityFEAT', __NAMESPACE__.'\\UtilityFeaturesCollection::get_collection' );
